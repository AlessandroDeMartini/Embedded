...
Timer1 = OSTmrCreate ( delay, // INT32U dly,                              	// number that is the initial delay
                       3, // INT32U period,                           	// number that is the amount of time it will take before the timer expires
                       OS_TMR_OPT_PERIODIC, // INT8U opt,             	// should chose between OS_TMR_OPT_PERIODIC that stand for periodic or OS_TMR_OPT_ONE_SHOT only once
                       NULL,                	// callback function ?? shold be defined prior OSTmrStop()
...
if( err = OS_ERR_NONE){
  printf("Timer created but not started")
}
